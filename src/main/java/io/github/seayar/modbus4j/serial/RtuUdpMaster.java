...
public class RtuUdpMaster extends ModbusMaster {

    public RtuUdpMaster(IpParameters parameters, boolean validateResponse) {
        super(createTransport(parameters), validateResponse);
    }

    public RtuUdpMaster(ModbusTransport transport, boolean validateResponse) {
        super(transport, validateResponse);
    }

    private static ModbusTransport createTransport(IpParameters parameters) {
        return new UdpTransport(parameters, ModbusCodecType.RTU, true, null);
    }
}
