 ...
 * @date 2026-08-12
 */
package io.github.seayar.modbus4j.serial;
...
public class AsciiUdpMaster extends ModbusMaster {

    public AsciiUdpMaster(IpParameters parameters, boolean validateResponse) {
        super(createTransport(parameters), validateResponse);
    }

    public AsciiUdpMaster(ModbusTransport transport, boolean validateResponse) {
        super(transport, validateResponse);
    }

    private static ModbusTransport createTransport(IpParameters parameters) {
        return new UdpTransport(parameters, ModbusCodecType.ASCII, true, null);
    }
}
