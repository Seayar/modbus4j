...
public interface ModbusTransport {
    ...
    AbstractModbusResponse send(AbstractModbusRequest request) throws ModbusTransportException;

    Future<AbstractModbusResponse> sendAsync(AbstractModbusRequest request) throws ModbusTransportException;
