...
public class ReadFileRecordRequest extends AbstractModbusRequest {
    private final List<FileRecord> records;

    public ReadFileRecordRequest(int slaveId, List<FileRecord> records) {
    ...
    protected int getDataLength() {
        return 1 + records.size() * 7;
    }

    @Override
    protected void writeData(ByteBuf buf) {
        buf.writeByte(records.size() * 7);
